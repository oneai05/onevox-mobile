-- OneVox - schema inicial (perfis + uso) com RLS
-- Aplicar com: supabase db push  (apos supabase link)
-- Ref: docs/MEDICAO-USO.md
...
-- cada usuario le apenas o proprio uso (escrita e feita pelo backend com service_role,
-- que ignora RLS)
